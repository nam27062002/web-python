...
urlpatterns = [
    ...
    path('getFollowings/<str:username>',
         views.getFollowings, name="getFollowings"),
    ...
    path('getCommentsPost/<str:postId>',
         views.getCommentsPost, name='getCommentsPost'),
    path('getNumLikesCmts/<str:postId>',
         views.getNumLikesCmts, name='getNumLikesCmtsPost'),
